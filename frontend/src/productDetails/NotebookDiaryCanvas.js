      ...
      <div className="section">
        ...
        <div className="customization-section">
          ...
          <div className="custom-info-div">
            <span>
              <label name="notebookSize">Size</label>
              <select
                value={input.notebookSize}
                onChange={(e) => {
                  setInput((prev) => ({
                    ...prev,
              ...
              >
                ...
                <option value="Long Size Notebook">Long Size Notebook</option>
                <option value="Small Exercise Notebook">
                  Small Exercise Notebook
                </option>
            ...
            <span>
              <label name="materialType">Cover Material</label>
              <select
              ...
              >
                <option value=""></option>
                <option value="Lykam Matte Coated Paper">
                  Lykam Matte Coated Paper
                </option>
                <option value="Ninbostar Art Paper-350 gsm">
                  Ninbostar Art Paper-350 gsm
                </option>
              </select>
            </span>
            <span>
              <label name="noOfPages">No. Of pages</label>
              <select
                value={input.noOfPages}
                onChange={(e) => {
                  setInput((prev) => ({ ...prev, noOfPages: e.target.value }));
                }}
              >
                <option to=""></option>
                <option to="80 pages / 40 sheets">80 pages(40 sheets)</option>
                <option to="UB Sticker">160 pages(80 sheets)</option>
              </select>
            </span>
          </div>
          ...
          <div className="custom-info-div">
            <span>
              <label name="lamination">Lamination</label>
              <select
                value={input.lamination}
                onChange={(e) => {
                  setInput((prev) => ({ ...prev, lamination: e.target.value }));
                }}
              >
                <option value=""></option>
                <option value="Matte Lamination">Matte Lamination</option>
                <option value="Wood">Glossy Lamination</option>
              </select>
            </span>
            <span>
              <label name="paperType">Paper Type</label>
              <select
                value={input.paperType}
                onChange={(e) => {
                  setInput((prev) => ({ ...prev, paperType: e.target.value }));
                }}
              >
                <option value=""></option>
                <option value="80 gsm White Paper">80 gsm White Paper</option>
              </select>
            </span>
            <span>
              <label name="innerPagePrintType">Inner Page Print</label>
              <select
                value={input.innerPagePrintType}
                onChange={(e) => {
                  setInput((prev) => ({
                    ...prev,
                    innerPagePrintType: e.target.value,
                  }));
                }}
              >
                <option to=""></option>
                <option to="Blank Pages">Blank Pages</option>
                <option to="Grid Pages">Grid Pages</option>
                <option to="Line Pages">Line Pages</option>
                <option to="Diary Pages">Diary Pages</option>
                <option to="Dotted Pages">Dotted Pages</option>
                <option to="Blank Pages">To-do-List Pages</option>
              </select>
            </span>
          </div>
          ...
          <div className="custom-info-div">
            ...
            <span>
              <label name="bindingType">Bind Type</label>
              <select
              ...
              >
                ...
                <option value="Staple Pin Binding">Staple Pin Binding</option>
                <option value="Perfect Binding">Perfect Binding</option>
              </select>
            </span>
            <span>
              <label name="productColor">Color</label>
              <select
                value={input.productColor}
                onChange={(e) => {
                  setInput((prev) => ({
                    ...prev,
              ...
              >
                <option to=""></option>
                <option to="Black">Black</option>
                <option to="Yellow">Yellow </option>
                <option to="White">White</option>
                <option to="Parrot Green">Parrot Green</option>
                <option to="Red">Red </option>
                <option to="Tobacco">Tobacco</option>
              </select>
            </span>
          </div>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td rowSpan={4}>{input.materialType}</td>
            ...
            <td rowSpan={4}>{input.quantity}</td>
            <td rowSpan={4}>{input.notebookSize}</td>
            <td rowSpan={4}>{input.lamination}</td>
            <td rowSpan={4}>{input.paperType}</td>
            <td rowSpan={4}>{input.noOfPages}</td>
            <td rowSpan={4}>{input.innerPagePrintType}</td>
            <td rowSpan={4}>{input.bindingType}</td>
...
export default NotebookDiaryCanvas;
