    ...
    const fetchImages = async () => {
      try {
        ...
        const objectImages = {
          ...
          sleeves: `${backendEndApiBannerUpload}${imageArray[2]}`,
        };
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex gap-2">
        ...
        <button onClick={() => handleViewChange("sleeves")}>Sleeves</button>
      </div>
      ...
      <TshirtCanvas
        ...
        preview={preview} // ✅ Pass down
        combinedRef={combinedRef} // ✅ pass it
      />

      {preview && <ViewAllCustomized customImages={customImages} />}
