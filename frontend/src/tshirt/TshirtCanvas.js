  ...
  (
    ...
    useEffect(() => {
      ...
      if (current) {
        ...
        // setLogoPreview(current.logoPreview || null);
      }
    ...
    const tshirtBaseImages = {
      ...
      sleeves: `${backendEndApiBannerUpload}${sideImages[2]}`,
    };
    ...
    const handleDownload = async () => {
      ...
      if (!canvasElem) {
        console.warn("combinedRef is null — cannot generate preview.");
        return;
      }
      ...
      onSave(currentView, dataUrl);
      setPreview(!preview); // toggle preview
    };
